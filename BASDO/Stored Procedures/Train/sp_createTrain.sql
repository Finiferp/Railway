...
BEGIN
    ...
    SET v_JSONSchema = '{
        ...
        "properties": {
            "name": {"type": "string"},
            "idRailway": {"type": "number"},
            "idAsset_Starts": {"type": "number"},
            "idAsset_Destines": {"type": "number"},
            "willReturnWithGoods": {"type": "boolean"}
        },
        "required": ["name", "idRailway", "idAsset_Starts", "idAsset_Destines", "willReturnWithGoods"]
    }';
